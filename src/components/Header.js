  ...
  return (
    <div className="grid grid-cols-12 shadow-lg py-1 bg-black text-white">
      ...
      <div className="flex justify-center col-start-5 col-end-9 py-1 px-2 rounded-full">
        <input
          className="px-4 w-full rounded-tl-full rounded-bl-full border border-gray-800 bg-black"
          type="text"
          placeholder="Search here"
        ></input>
        <button className="px-6 rounded-tr-full rounded-br-full border border-gray-800 border-l-0 bg-gray-900 text-white">
          <SearchIcon />
        </button>
      </div>
